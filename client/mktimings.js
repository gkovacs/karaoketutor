...
var root, getTimingLogsFirst, getTimingLogs, playServerTimingLogsFirst, playServerTimingLogs, submitTimingLogs, playbackRecorded, scrollToView, incrementActiveIndex, decrementActiveIndex, setActiveIndex, setActiveIndexAll, togglePlayPause, onYouTubeIframeAPIReady, injectScriptTag, mouseoverFN;
...
playbackRecorded = root.playbackRecorded = function(timingList){
  ...
  for (i$ = 0, len$ = timingList.length; i$ < len$; ++i$) {
    results$.push((fn$.call(this, i$, timingList[i$])));
  }
  return results$;
  function fn$(timingIdx, wordIdx){
